<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KeMu.aspx.cs" Inherits="Setting_KeMu" %>
...
<body class="easyui-layout">
    <div data-options="region:'center'" style="padding: 1px">
        <div title="科目管理" class="easyui-panel">
        </div>
        <table id="dg" class="easyui-datagrid" style="padding: 0px" url="KeMuData.aspx?action=read"
        ...
        <div id="dlg" class="easyui-dialog" style="width: 400px; height: 350px; padding: 10px 20px"
            ...
            <div class="fitem">
                <label>
                    科目:</label>
                <input name="KM" class="easyui-validatebox" required="true">
            </div>
            <div class="fitem">
                <label>
                    借/贷:</label>
                <input name="JD" class="easyui-validatebox" />
            </div>
        </form>
    </div>
    <div id="dlgbuttons">
    ...
    <script type="text/javascript">
        ...
        function newPartner() {
            ...
            $('#fm').form('clear');
            url = 'KeMuData.aspx?action=create';
        }
        function editPartner() {
            ...
            if (row) {
                ...
                $('#fm').form('load', row);
                url = 'KeMuData.aspx?action=update&id=' + row.ID;
            }
        }
        ...
        function destroyPartner() {
            ...
            if (row) {
                $.messager.confirm('Confirm', '确认删除?', function (r) {
                    if (r) {
                        $.post('KeMuData.aspx?action=delete', { id: row.ID }, function (result) {
                            if (result.success) {
                                $('#dg').datagrid('reload');
