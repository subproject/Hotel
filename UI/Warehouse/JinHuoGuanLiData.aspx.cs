...
public partial class Warehouse_JinHuoGuanLiData : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (action)
        {
            ...
            case "getOrderId":
                ...
                inOrderHelper.CreateInOrder(inOrderModel);
                result = "{id:" + inOrderModel.ID + ",ordernum:\"" + (inOrderModel.ID + 1).ToString("00000000") + "\"}";
                break;
            case "saveOrder":
                ...
                if (rlt == "0")
                {
                    ...
                    if (rlt == "0")
                    {
                        //添加供应商进货次数WH_Supplier new GoodsStockHelper().UpdateSupplier2
                        SupplierViewModel svm = new SupplierViewModel();
                        new SupplierHelper().UpdateSupplier2(Convert.ToInt32(supplier), totalmoney);
