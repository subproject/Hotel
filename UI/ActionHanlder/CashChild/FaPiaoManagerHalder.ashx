<%@ WebHandler Language="C#" Class="FaPiaoManagerHalder" %>
...
public class FaPiaoManagerHalder : IHttpHandler, IReadOnlySessionState 
{
    FaPiaoManagerHelper KFHelper = FaPiaoManagerHelper.Instance;
