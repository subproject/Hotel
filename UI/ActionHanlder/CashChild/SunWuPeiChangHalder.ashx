<%@ WebHandler Language="C#" Class="SunWuPeiChangHalder" %>
...
public class SunWuPeiChangHalder : IHttpHandler, IReadOnlySessionState 
{
    SunWuPeiChangHelper KFHelper = SunWuPeiChangHelper.Instance;
