<%@ WebHandler Language="C#" Class="QingTaFuXianHalder" %>
...
public class QingTaFuXianHalder : IHttpHandler, IReadOnlySessionState 
{
    QingTaFuXianHelper KFHelper = QingTaFuXianHelper.Instance;
    public void ProcessRequest(HttpContext context) {       
        ...
        { 
            ...
            case "SelByOrderGuid":
                ...
                break;
            case "SelQianTaiPayTypes":
                actionresult = SelQianTaiPayTypeList(context.Request.Form);
                break;
    ...
    public string SelQianTaiPayTypeList(NameValueCollection parameters)
    {
        int total = 0;
        string result = Utils.ToRecordJson(KFHelper.GetQianTaiPayTypeList(parameters, out total), total);
        return result;
    }
