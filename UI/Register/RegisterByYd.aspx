<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterByYd.aspx.cs" Inherits="RegisterByYd" %>
...
//            }
        ...
        function CreateRegister() {
           ...
           $('#fm').form('submit', {
               url: 'SaveRegisterData.aspx?action=createYdRuzhu&list=' + rzstr + '&sk=' + skstr + '&ydnum=' + ydnumyd,
               onSubmit: function () {
            ...
            $('#SuikeData').datagrid({
                onClickRow: function (index, data) {
                    ...
                    if (row) {
                        ...
                        var rowIndex = $('#SuikeData').datagrid('getRowIndex', $('#SuikeData').datagrid('getSelected'));
                        $.messager.show({ title: 'information', msg: '选中随客信息' });
                    }
                }
            })
        });
